...
summary: Analysis of Olympic Games medal table with pandas and matplotlib
date: 2021-03-18
authors:
  - me
categories:
...
![png of stacked bar charts representing the top ten countries in terms of total number of medals in the winter and summer games](output_6_0.png)
...
![png showing adjusted gold medals versus the rank of countries with reference to the number of total medals won](output_8_0.png)
