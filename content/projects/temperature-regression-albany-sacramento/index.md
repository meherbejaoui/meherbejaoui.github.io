...
summary: Unlock climate insights with a data-driven exploration of Albany and Sacramento
  temperatures. Leveraging NOAA datasets and Python tools, delve into their distinct
  weather patterns through a multiregression lens
date: 2023-12-29
authors:
  - me
categories:
...
![pair plots grid figure of selected variables for Sacramento](output_15_0.png)
...
![heatmap figure for correlation coefficients for Sacramento](output_17_0.png)
...
![pair plots grid figure of selected variables for Albany](output_24_0.png)
...
![heatmap figure for correlation coefficients for Albany](output_25_0.png)
...
![Residuals vs. Fitted figure for Sacramento](output_34_0.png)
...
![Normal Q-Q plot for Sacramento](output_36_0.png)
...
![Residuals vs. Fitted figure for Albany](output_44_0.png)
...
![Normal Q-Q plot for Albany](output_46_0.png)
