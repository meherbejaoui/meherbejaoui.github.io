...
summary: Using pandas and matplotlib, to generate and style Word Clouds, count words
  using the Counter collection and compare different documents
date: 2021-04-08
authors:
  - me
categories:
...
![png showing Hydrocarbons code cloud as the Tunisian map](output_13_0.png)
...
![png showing Tunisian Constitution Cloud as the Tunisian flag](output_18_0.png)
...
![picture showing DataFrame of occurrences and total for each word in both documents](dataframe_occurrences_and_total_of_each_word_in_both_documents.png)
...
![picture showing DataFrame of occurrences and total for word that appeared at least 10 times in both documents](dataframe_occurrences_and_total_of_word_that_appeared_at_least_ten_times.png)
