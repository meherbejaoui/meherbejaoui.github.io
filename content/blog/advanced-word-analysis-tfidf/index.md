...
summary: An explanation of text analysis using CountVectorizer and TfidfVectorizer
  from scikit-learn
date: 2021-04-21
authors:
  - me
...
In a previous [article](/blog/counting-words-countvectorizer/), we utilized **CountVectorizer** from scikit-learn to count words. We used bag of words analysis, where a text is represented as the bag of its words, disregarding grammar, and with no particular order. This model may capture the characteristics of the text or document.
...
![png showing subset of words accross all documents](counts.png)
...
![png showing subset of words accross all documents for tfidf counts](tfidfcounts.png)
...
![png showing subset of words accross all documents for idf counts](idfcounts.png)
