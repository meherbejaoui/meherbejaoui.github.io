...
summary: Using CountVectorizer to count words in multiple documents
date: 2021-04-10
authors:
  - me
categories:
...
## Introduction
In a previous [article](/blog/visualization-analysis-legal-texts/), we used simple techniques to visualize and count words in a document. In this notebook, we will be using another technique. The [`CountVectorizer`](https://scikit-learn.org/stable/modules/generated/sklearn.feature_extraction.text.CountVectorizer.html#sklearn.feature_extraction.text.CountVectorizer) from scikit-learn is more elaborate than the `Counter` tool. It converts a collection of text documents to a matrix of token counts.
...
![DataFrame showing the counts](dataframe_of_counts.png)
...
![DataFrame showing the sorted list of counts](dataframe_of_sorted_list.png)
...
![DataFrame showing the name of documents and preview of their content](dataframe_showing_name_of_document_and_content.png)
...
![DataFrame of the words counted in the three documents](dataframe_showing_counts_of_three_documents.png)
...
![DataFrame of interesting words checked in all three documents](dataframe_showing_counts_of_interesting_words.png)
